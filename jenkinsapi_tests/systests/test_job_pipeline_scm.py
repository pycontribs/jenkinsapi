import pytest
from jenkinsapi_tests.systests.job_configs import PIPELINE_SCM_CONF_TEST_PARAMS, PIPELINE_SCM_JOB
...
def test_pipeline_scm(job : Job):
    ...
    """
    assert job.get_scm_type() == job._scm_map[PIPELINE_SCM_CONF_TEST_PARAMS['scm_class']]
